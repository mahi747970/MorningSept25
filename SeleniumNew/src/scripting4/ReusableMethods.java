...
public class ReusableMethods
{
    ...
    public static boolean deleteUser(WebDriver oBrowser, String userName){
        try{
            oBrowser.findElement(By.xpath(String.format(ObjectLocator.obj_UserName_Link,userName))).click();
            Thread.sleep(2000);
            oBrowser.findElement(ObjectLocator.obj_LoginPage_Header).click();
            Thread.sleep(2000);
